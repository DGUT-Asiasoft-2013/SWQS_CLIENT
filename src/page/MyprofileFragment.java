...
import com.swqs.schooltrade.AvatarView;
import com.swqs.schooltrade.BuyAndSelledActivity;
import com.swqs.schooltrade.BuyEvaluationDetailsActivity;
import com.swqs.schooltrade.Money;
import com.swqs.schooltrade.MyCollection;
import com.swqs.schooltrade.MyCredit;
import com.swqs.schooltrade.R;
import com.swqs.schooltrade.Recharge;
...
view.findViewById(R.id.tvUser).setOnClickListener(new OnClickListener() {
	...
	private void goUser(){
		Intent itnt = new Intent(getActivity(),Money.class);
		startActivity(itnt);
	}
