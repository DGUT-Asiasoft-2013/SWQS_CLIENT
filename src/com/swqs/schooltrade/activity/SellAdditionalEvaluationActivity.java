...
public class SellAdditionalEvaluationActivity extends Activity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.activity_sell_additional_evaluation);
	...
	void goSellOrderDetails(){
		Intent itnt = new Intent(this,SellOrderDetailsActivity.class);
		startActivity(itnt);
	}
