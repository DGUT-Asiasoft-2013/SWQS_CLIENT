...
import cn.jmessage.android.uikit.chatting.adapter.AlbumListAdapter;
import cn.jmessage.android.uikit.chatting.bean.ImageBean;
import cn.jmessage.android.uikit.chatting.utils.SortPictureList;
...
//		mGroupGridView = (GridView) findViewById(R.id.pick_picture_total_grid_view);
		...
		mListView.setOnItemClickListener(new OnItemClickListener() {
			...
			public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
				...
				startActivityForResult(mIntent, TradeApplication.REQUEST_CODE_SELECT_ALBUM);
	...
	protected void onActivityResult(int requestCode, int resultCode, Intent data) {
		...
		if (resultCode == TradeApplication.RESULT_CODE_SELECT_ALBUM) {
			setResult(TradeApplication.RESULT_CODE_SELECT_PICTURE, data);
			finish();
		}
	}
