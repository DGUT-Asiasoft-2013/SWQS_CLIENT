...
import com.swqs.schooltrade.activity.MainActivity;
...
//                dialog = DialogCreator.createBaseCustomDialog(mContext, title, msg, onClickListener);
                break;
            case user_logout:
                String title = mContext.getString(R.string.user_logout_dialog_title);
                String msg = mContext.getString(R.string.user_logout_dialog_message);
                dialog = DialogCreator.createBaseCustomDialog(mContext, title, msg, onClickListener);
