...
import cn.jmessage.android.uikit.chatting.adapter.PickPictureAdapter;
...
public class PickPictureActivity extends BaseActivity {
    ...
    private OnItemClickListener onItemListener = new OnItemClickListener() {
        ...
        public void onItemClick(AdapterView<?> viewAdapter, View view, int position, long id) {
            ...
            intent.putExtra(TradeApplication.POSITION, position);
            ...
            startActivityForResult(intent, TradeApplication.REQUEST_CODE_BROWSER_PICTURE);
        }
    };
    ...
    public void onActivityResult(int requestCode, int resultCode, Intent data) {
        if (resultCode == TradeApplication.RESULT_CODE_SELECT_PICTURE) {
            if (data != null) {
        ...
        } else if (resultCode == TradeApplication.RESULT_CODE_BROWSER_PICTURE) {
            setResult(TradeApplication.RESULT_CODE_SELECT_ALBUM, data);
            finish();
        }
    }
        ...
        public void handleMessage(android.os.Message msg) {
            ...
            if (activity != null) {
                switch (msg.what) {
                    case SEND_PICTURE:
                        Intent intent = new Intent();
                        intent.putExtra(TradeApplication.MsgIDs, activity.mMsgIds);
                        activity.setResult(TradeApplication.RESULT_CODE_SELECT_ALBUM, intent);
